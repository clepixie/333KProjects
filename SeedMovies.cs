...
namespace Team1_FinalProject.Seeding
{
	...
	{
		public static void SeedMovies(AppDbContext db)
		{
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Comedy"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3003,
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Family"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3004,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Drama"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3006,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Action"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3009,
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Adventure"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3010,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Musical"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3012,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Animation"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3016,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Thriller"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3019,
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Crime"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3020,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Western"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3025,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Horror"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3032,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Romance"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3065,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Science Fiction"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3080,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "War"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3086,
		...
		AllMovies.Add(new Movie
		{
			...
			Genre = db.Categories.FirstOrDefault(c => c.GenreName == "Fantasy"),
		});
		AllMovies.Add(new Movie
		{
			MovieID = 3099,
